<div class="sidebar sidebarDerecha barra-lateral" data-image="{{ asset('material') }}/img/sidebar-1.jpg">
    ...
    <div class="logo">
        <a href="{{ url('dashboard', session('id')) }}"class="nav-item{{ $activePage == 'dashboard' ? ' active' : '' }}">
            <img src="{{ asset('img/react.png') }}" class="mx-auto d-block " width="30%">
        </a>
    </div>
        ...
        <ul class="nav">
            ...
            <li class="nav-item {{ $activePage == 'dashboard' || $activePage == 'user-management' ? ' active' : '' }}">
                <a href="#equipo" onmouseover="cambiar();" onmouseout="volver();" class="nav-link p-2"
                    ...
                    <i><img id="cambiaBCO"
                            ssrc="{{ $activePage == 'equipos' ? ' img/navs/eqiposMenuBCO.svg' : '/img/navs/eqiposMenu.svg' }}"
                            style="width:25px"> </i>
                    <p>{{ __('Equipos') }}
                        <b class="caret"></b>
                    </p>
            ...
            <li class="nav-item {{ $activePage == 'Examenes' || $activePage == 'user-management' ? ' active' : '' }}">
                <a class="nav-link p-2" onmouseover="cambiar4();" onmouseout="volver4();" data-toggle="collapse"
                    href="#confiexamenes" aria-expanded="false">
                    <i><img id="cambiaBCO4"
                            src="{{ $activePage == 'obra' ? ' img/navs/obrasMenuBCO.svg' : '/img/navs/obrasMenu.svg' }}"
                            style="width:25px"></i>
                    <p>{{ __('Examenes') }}
                ...
                <div class="collapse " id="confiexamenes">
                    <ul class="nav">
                        <li class="nav-item{{ $activePage == 'profile' ? ' active' : '' }}">
                            <a
                        ...
                        <li class="nav-item{{ $activePage == 'user-management' ? ' active' : '' }}">
                            <a class="nav-link py-2 ps-5" href="{{ route('parametros.index') }}">
                                <span class="sidebar-normal py-2 ps-5"> {{ __('Parametros') }} </span>
                            </a>
                        </li>
                    </ul>
                </div>
